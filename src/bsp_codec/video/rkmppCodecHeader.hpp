...
struct rkmppCodecHeader
{
    static const std::unordered_map<std::string, MppCodingType> strToMppCodingMap;
    static const std::unordered_map<MppCodingType, std::string> mppCodingToStrMap;
    static const std::unordered_map<std::string, MppFrameFormat> strToMppFrameFormatMap;
    static const std::unordered_map<MppFrameFormat, std::string> mppFrameFormatToStrMap;

};

const std::unordered_map<std::string, MppCodingType> rkmppCodecHeader::strToMppCodingMap{
...
const std::unordered_map<MppCodingType, std::string> rkmppCodecHeader::mppCodingToStrMap{
...
const std::unordered_map<std::string, MppFrameFormat> rkmppCodecHeader::strToMppFrameFormatMap{
...
const std::unordered_map<MppFrameFormat, std::string> rkmppCodecHeader::mppFrameFormatToStrMap{
